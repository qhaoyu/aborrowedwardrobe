...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-sm border border-[color:var(--color-line)] bg-white/40 transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-xl"
    >
